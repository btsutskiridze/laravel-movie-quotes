                        ...
                        <tbody class="divide-y divide-gray-400 bg-white">
                            ...
                            <tr>
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div class="font-medium text-gray-900"><a href="{{route('movie.show_quotes',['movie'=> $movie->slug,])}}">{{ucwords($movie->title)}}</a></div>
                                ...
                                <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                                    <a href="{{route('movie.edit',$movie)}}" class="text-blue-500 hover:text-blue-700">Edit</a>
                                </td>
                                <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                                    {{-- <a href="/admin/posts/{{$post->id}}/edit" class="text-blue-500 hover:text-blue-700">Delete</a> --}}
                                    <form action="{{route('movie.delete',$movie)}}" method="POST" class="grid place-items-center">
                                        @csrf
                                        @method("DELETE")
