...
Route::delete('admin/quotes/{quote}', [AdminQuoteController::class, 'destroy'])->middleware('admin')->name('quote.destroy');
...
Route::delete('admin/movies/{movie:slug}', [AdminMovieController::class, 'destroy'])->middleware('admin')->name('movie.destroy');